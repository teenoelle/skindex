...
const CURATED: Record<string, string> = {
  ...
  "sodium hyaluronate": "Sodium hyaluronate is the sodium salt of hyaluronic acid and a powerful humectant that binds up to 1,000 times its weight in water. Its smaller molecular size allows better skin penetration than hyaluronic acid, plumping the skin and visibly reducing fine lines.",
  "hyaluronic acid": "Hyaluronic acid is a humectant naturally found in the skin that holds large amounts of water to keep skin plump and hydrated. In topical formulas it draws moisture to the surface and helps maintain a smooth, supple appearance.",
  ...
  // ── Emollients ─────────────────────────────────────────────────────────
  "squalane": "Squalane is a stable, plant-derived emollient (usually from sugarcane or olives) that closely mimics the skin's natural sebum. It absorbs quickly without greasiness and is non-comedogenic, making it suitable for oily, sensitive, and acne-prone skin.",
